---
title:  "[프로그래머스/SQL] 어린 동물 찾기(59037) 풀이"
...
# 문제 정보
 ...
 - 문제 링크: [어린 동물 찾기(59037)](https://school.programmers.co.kr/learn/courses/30/lessons/59037)
...
`WHERE INTAKE_CONDITION != "Aged"`로 조건을 걸고,
`ORDER BY ANIMAL_ID`로 정렬하면 됩니다.
