...
date: 2026-03-14 12:10:00 +09:00
...
`app-ads.txt` 자체는 한 줄이라 단순해 보이지만, 실제 반영은 파일 내용보다도 연결 경로와 공개 URL 정합성에서 갈리는 경우가 많습니다.

핵심은 Play Console에 저장한 URL과 같은 도메인 루트에서 파일이 200으로 열리는지 먼저 확인하고, 그 다음에 `google.com, pub-..., DIRECT, f08c47...` 형식과 하위 경로 중복 여부를 점검하는 순서로 보는 것입니다.

또 수정 직후 바로 실패로 단정하기보다 24~48시간 정도의 반영 지연을 감안하고 확인하는 편이 운영상 훨씬 안정적이었습니다.
