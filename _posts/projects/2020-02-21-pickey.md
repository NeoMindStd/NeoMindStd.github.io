...
description: "네이버의 데이터를 기반으로 하여 두 검색어를 제시, 그 중 많이 검색된 것을 맞추는 웹 게임과 해당 웹을 사용하는 웹 뷰어 어플리케이션"
...
### 웹사이트
 ...
 - 성과: (2020-02-21 기준) 일반 게임 33,394회 이상, 타임 어택 5,431회 이상 플레이,<br>
        트위치 스트리머이자 유튜버인 [따효니](https://www.twitch.tv/ddahyoni/), [옥냥이](https://www.twitch.tv/rooftopcat99/), [공혁준](https://www.twitch.tv/rhdgurwns/)이 플레이<sup id="tupleH1">[1](#tupleT1)</sup>
 - 옥냥이 플레이 영상(유튜브)
...
### 어플리케이션
 - 배포: [플레이 스토어](https://play.google.com/store/apps/details?id=std.neomind.pickeywebview)(현재는 유지보수 하지 않고있어 이용이 불가능합니다)
