---
title: "AI 코딩 도구 허브"
permalink: /ai/coding-tools/
layout: single
excerpt: "Codex, Claude Code, Cursor, Copilot, Gemini CLI처럼 코드 작업에 바로 쓰는 AI 도구를 설치형과 비교형으로 묶은 허브입니다."
description: "AI 코딩 도구를 한곳에서 비교하고, 설치 가이드와 개념 글까지 이어서 볼 수 있게 정리한 NeoMind 허브 페이지입니다."
---
