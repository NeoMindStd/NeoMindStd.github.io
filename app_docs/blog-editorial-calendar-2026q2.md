# Blog Editorial Calendar (2026 Q2)

NeoMind 블로그의 문제풀이 편중 구조를 유지하면서 검색 유입형 글을 확대하기 위한 운영 캘린더입니다.

## Status Key

- `published`: 이번 배치에서 발행 완료
- `queued`: 다음 배치 후보

## Plan

| No | Topic | Slug | Category | Status |
|---|---|---|---|---|
| 1 | Google Play app-ads.txt 적용 방법과 실제 반영 체크리스트 | `google-play-app-ads-txt-checklist` | 기타 | published |
| 2 | Jetpack Compose + AdMob 전면 광고 겹침 문제 해결기 | `compose-admob-interstitial-overlap-fix` | 기타 | published |
| 3 | Disqus 댓글 알림 자동화: GitHub Actions + Python | `disqus-comment-alert-github-actions-python` | 기타 | published |
...
- `/기타/google-play-app-ads-txt-checklist/`
- `/기타/compose-admob-interstitial-overlap-fix/`
- `/기타/disqus-comment-alert-github-actions-python/`
